        ...
        for item_loc in self.distill_cfg:
            ...
            for item_loss in item_loc.methods:
                ...
                if str(loss_name).startswith('adv'):
                    student_loss[loss_name] = self.distill_losses[loss_name](student_feat[4:8],teacher_feat[4:8])
                else:
                    student_loss[loss_name] = self.distill_losses[loss_name](student_feat[0:4], teacher_feat[0:4])

        img_feat = tuple(f[0:4] for f in stu_feat)
